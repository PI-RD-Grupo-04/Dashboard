				...
				<nav aria-label="breadcrumb">
					<ol
						...
						<li class="breadcrumb-item text-sm text-dark active"
							aria-current="page">Tipo de Frete</li>
					</ol>
					<h1 class="-bolder mb-0">Tipo de Frete</h1>
					<form action="ServletTipoFrete" method="post">
									...
									<table class="table mt-5">
										<thead class="thead-dark">
											<tr class="text-center">
												<th scope="col">Id</th>
												<th scope="col">Descrição tipo de frete</th>
												<th scope="col" class="align-left">Opções</th>
											</tr>
										</thead>
										<tbody>
											<c:forEach var="tipoFrete" items="${lista}">
												<form action="ServletTipoFrete" method="post">
													<tr class="text-center">
														<input type="hidden" name="id" value="${tipoFrete.id}" />
														<td>${tipoFrete.id}</td>
														<td>${tipoFrete.descricao_frete}</td>
														<!-- Modal -->
														<div class="modal fade" id="modelDelete-${tipoFrete.id}"
															...
															<div class="modal-dialog">
																<div class="modal-content">
																	...
																	<div class="modal-body">
																		...
																		${tipoFrete.descricao_frete} ? <input type="hidden" name="id"
																			value="${tipoFrete.id}" />
																	</div>
														...
														<td>
															<button type="button" data-bs-toggle="modal"
																...
																data-bs-target="#modelDelete-${tipoFrete.id}">Remover</button>
