			...
			<body class="g-sidenav-show  bg-gray-200">
				<aside
					...
					<div class="sidenav-header  justify-content-center ">
						<a class="navbar-brand m-0" href="ServletindexCarol"> <img src="imagens/fav-icon.png"
							...
							<ul class="navbar-nav">
								...
								<li class="nav-item d-grid gap-2">
									<button type="submit" name="option" value="tipoFreteSv"
										class="nav-link text-white justify-content-center btn-info ">Tipo de
										Frete</button>
								</li>
								<li class="nav-item d-grid gap-2">
						...
						<div class="container-fluid py-1 px-3">
							<nav aria-label="breadcrumb">
								<ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
									<li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark"
											href="#">Paginas</a></li>
									<li class="breadcrumb-item text-sm text-dark active" aria-current="page">Frete</li>
								</ol>
								<h1 class="-bolder mb-0">Frete</h1>
								<form action="ServletFrete" method="post">
									<button type="submit" class=" btn btn-info mb-3" name="option" value="insertForm">
							...
							<div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
								...
								<ul class="navbar-nav  justify-content-end">
									<li class="nav-item d-flex align-items-center "><i class="fa fa-user me-sm-1"></i>
										<c:choose>
																		...
																		<div class="modal-dialog">
																			<div class="modal-content">
																				...
																				<div class="modal-body">
																					Deseja excluir permanentemente o
																					Item:
																					${frete.tipo_freteTxt} ? <input
																						type="hidden" name="id"
																						value="${frete.id}" />
																				</div>
