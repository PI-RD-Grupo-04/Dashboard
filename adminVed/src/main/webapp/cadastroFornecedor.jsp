				...
				<nav aria-label="breadcrumb">
					<ol
						...
						<li class="breadcrumb-item text-sm text-dark active"
							aria-current="page">Fornecedor</li>
					</ol>
					<h1 class="-bolder mb-0"> Fornecedor</h1>
				</nav>
				...
				<div class="col-md-5 mx-auto border text-center">
					...
					<form method="post" action="ServletFornecedor">
						...
						<div class="form-group" style="text-align-last: left;">
							<label for="nome" class="form-label">Razão Social:</label> <input
								type="text" class="form-control" name="razao_social"
								value="${fornecedor.razao_social}"
								style="background-color: rgb(255, 255, 255);" required>
						</div>
						<div class="form-group" style="text-align-last: left;">
							<label for="nome" class="form-label">CNPJ:</label> <input
								type="text" class="form-control"
								style="background-color: rgb(255, 255, 255);" name="cnpj"
								value="${fornecedor.cnpj}" id="cnpj" required>
						</div>
						<div class="form-group" style="text-align-last: left;">
							<label for="nome" class="form-label">E-mail:</label> <input
								type="text" class="form-control"
								style="background-color: rgb(255, 255, 255);" name="email"
