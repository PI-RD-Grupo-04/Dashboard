				...
				<nav aria-label="breadcrumb">
					<ol
						...
						<li class="breadcrumb-item text-sm text-dark active"
							aria-current="page">Categoria</li>
					</ol>
					<h1 class="-bolder mb-0">Categorias</h1>
											...
											<c:forEach var="categoria" items="${lista}">
												<form action="ServletCategoria" method="post">
													<tr class="text-center">
														...
														<!-- Modal -->
														<div class="modal fade" id="modelDelete-${categoria.id}"
															...
															<div class="modal-dialog">
																<div class="modal-content">
																	...
																	<div class="modal-body">
																		...
																		${categoria.descricao} ? <input type="hidden"
														...
														<td>
															<button type="button" data-bs-toggle="modal"
																...
																data-bs-target="#modelDelete-${categoria.id}">Remover</button>
				...
				<script>
					...
					if (win && document.querySelector('#sidenav-scrollbar')) {
						...
						Scrollbar.init(document
								.querySelector('#sidenav-scrollbar'), options);
					}
				</script>
