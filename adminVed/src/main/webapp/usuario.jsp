			...
			<div class="container-fluid py-1 px-3">
				<nav aria-label="breadcrumb">
					<ol
						...
						<li class="breadcrumb-item text-sm text-dark " aria-current="page">Usuários</li>
					</ol>
					<h1 class="-bolder mb-0">Usuários</h1>
											...
											<c:forEach var="usuario" items="${lista}">
												<form action="ServletUsuario" method="post">
													<tr class="text-center">
														...
														<td>${usuario.email}</td>
														<!-- Modal -->
														<div class="modal fade" id="modelDelete-${usuario.id}"
															...
															<div class="modal-dialog">
																<div class="modal-content">
																	...
																	<div class="modal-body">
																		Deseja excluir permanentemente o Usuario:
																		${usuario.nome} ? <input type="hidden"
														...
														<td>
															<button type="button" data-bs-toggle="modal"
																...
																data-bs-target="#modelDelete-${usuario.id}">Remover</button>
