			...
			<div class="container-fluid py-1 px-3">
				<nav aria-label="breadcrumb">
					<ol
						...
						<li class="breadcrumb-item text-sm text-dark " aria-current="page">Status
							Produto</li>
					</ol>
					<h1 class="-bolder mb-0">Status do Produto</h1>
					<form action="ServletStatusProduto" method="post">
					...
					<div class="col-12">
						<div class="card my-4">
							...
							<div class="card-body px-0 pb-2">
								<div class="table-responsive p-0 overflow-scroll over ">
									<table class="table mt-5     ">
										...
										<tbody>
											<c:forEach var="statusProduto" items="${lista}">
												<form action="ServletStatusProduto" method="post">
													<tr class="text-center">
														<input type="hidden" name="id" value="${statusProduto.id}" />
														<td>${statusProduto.id}</td>
														<td>${statusProduto.descricao}</td>
														<!-- Modal -->
														<div class="modal fade"
															id="modelDelete-${statusProduto.id}" tabindex="-1"
															...
															<div class="modal-dialog">
																<div class="modal-content">
																	...
																	<div class="modal-body">
																		...
																		${statusProduto.descricao} ? <input type="hidden"
																			name="id" value="${statusProduto.id}" />
																	</div>
														...
														<td>
															<button type="button" data-bs-toggle="modal"
																...
																data-bs-target="#modelDelete-${statusProduto.id}">Remover</button>
