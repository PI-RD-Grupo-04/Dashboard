					...
					<form method="post" action="ServletReceita">
						...
						<div class="form-group" style="text-align-last: left;">
							<label for="nome" class="form-label">Ingredientes:</label> <input
								type="text" class="form-control" name="ingredientes"
								value="${receita.ingredientes}"
								style="background-color: rgb(255, 255, 255);" required>
						</div>
						<div class="form-group" style="text-align-last: left;">
							<label for="nome" class="form-label">Preparo:</label> <input
								type="text" class="form-control"
								style="background-color: rgb(255, 255, 255);" name="preparo"
								value="${receita.preparo}" required>
						</div>
						<div class="form-group" style="text-align-last: left;">
							<label for="nome" class="form-label">Titulo:</label> <input
								type="text" class="form-control"
